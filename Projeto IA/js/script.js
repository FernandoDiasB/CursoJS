const apiKey = "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";
...
// Adicionando um evento de pressionar tecla
inputField.addEventListener("keydown", function(event) {
    // Verificando se a tecla pressionada é "Enter"
    if (event.key === "Enter") {
        // Obtendo o valor do campo de entrada
        const input = inputField.value;
        // Chamando a função para gerar imagens com o prompt fornecido
